  ...
  return (
    ...
    >
      <div className="relative mt-1">
        <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left bg-gray-200 rounded-lg border-2 border-gray-700 shadow-md cursor-pointer sm:text-sm focus-visible:ring-4 focus-visible:ring-offset-2 focus-visible:ring-indigo-300">
