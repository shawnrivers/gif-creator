  ...
  return (
    <div
      className={joinClassNames(
        ...
        } max-w-4xl min-h-full px-8 py-12 rounded-lg border-2 shadow-md flex flex-col items-center justify-center cursor-pointer focus-visible:ring-4 focus-visible:ring-offset-2 focus-visible:ring-indigo-300`,
        props.className
      )}
      {...getRootProps()}
    >
